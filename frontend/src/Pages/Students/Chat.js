...
function Chat() {
  return <div class="main-wrapper chat-wrapper">
                ...
                <nav aria-label="breadcrumb" class="page-breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                      <a href="https://dreamslms.dreamstechnologies.com/html/index.html">
                        Home
                      </a>
                    </li>
...
<a href="https://dreamslms.dreamstechnologies.com/html/student-profile.html"><img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user16.jpg" alt="Img"/></a>
</div>
</div>
<div class="profile-group">
<div class="profile-name text-center">
<h4><a href="https://dreamslms.dreamstechnologies.com/html/student-profile.html">Rolands Richard</a></h4>
<p>Student</p>
</div>
</div>
</div>
...
<ul>
<li class="nav-item ">
<a href="https://dreamslms.dreamstechnologies.com/html/student-dashboard.html" class="nav-link">
<i class="bx bxs-tachometer"></i>Dashboard
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-profile.html" class="nav-link">
<i class="bx bxs-user"></i>My Profile
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-courses.html" class="nav-link">
<i class="bx bxs-graduation"></i>Enrolled Courses
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-wishlist.html" class="nav-link">
<i class="bx bxs-heart"></i>Wishlist
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-reviews.html" class="nav-link">
<i class="bx bxs-star"></i>Reviews
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-quiz.html" class="nav-link">
<i class="bx bxs-shapes"></i>My Quiz Attempts
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-order-history.html" class="nav-link">
<i class="bx bxs-cart"></i>Order History
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-qa.html" class="nav-link">
<i class="bx bxs-bookmark-alt"></i>Question & Answer
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-referral.html" class="nav-link">
<i class="bx bxs-user-plus"></i>Referrals
</a>
</li>
<li class="nav-item active">
<a href="https://dreamslms.dreamstechnologies.com/html/student-messages.html" class="nav-link">
<i class="bx bxs-chat"></i>Messages
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-tickets.html" class="nav-link">
...
<ul>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/student-settings.html" class="nav-link ">
<i class="bx bxs-cog"></i>Settings
</a>
</li>
<li class="nav-item">
<a href="https://dreamslms.dreamstechnologies.com/html/index.html" class="nav-link">
                        ...
                        <div id="chats" class="left-sidebar-wrap sidebar active slimscroll">
                          <div class="slimscroll">
                            ...
                            <div class="top-online-contacts">
                              <div class="fav-title">
                                <h6>Online Now</h6>
                                <a href="#" class="view-all-chat-profiles">
                                  View All
                                </a>
                              </div>
                                ...
                                <div class="swiper-wrapper">
                                  <div class="swiper-slide">
                                    <div class="top-contacts-box">
                                      <div class="profile-img online">
                                        <a href="#">
                                          <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user12.jpg" alt="Image" />
                                        </a>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="swiper-slide">
                                    <div class="top-contacts-box">
                                      <div class="profile-img online">
                                        <a href="#">
                                          <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user2.jpg" alt="Image" />
                                        </a>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="swiper-slide">
                                    <div class="top-contacts-box">
                                      <div class="profile-img online">
                                        <a href="#">
                                          <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user3.jpg" alt="Image" />
                                        </a>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="swiper-slide">
                                    <div class="top-contacts-box">
                                      <div class="profile-img online">
                                        <a href="#">
                                          <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user5.jpg" alt="Image" />
                                        </a>
                                      </div>
                                    </div>
                                  </div>
                                  <div class="swiper-slide">
                                    <div class="top-contacts-box">
                                      <div class="profile-img online">
                                        <a href="#">
                                          <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user6.jpg" alt="Image" />
                                        </a>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div class="sidebar-body chat-body" id="chatsidebar">
                              ...
                              <ul class="user-list space-chat">
                                <li class="user-list-item chat-user-list">
                                  <a href="javascript:void(0);" class="status-active">
                                    <div class="avatar avatar-online">
                                      <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user12.jpg" class="rounded-circle" alt="image" />
                                    </div>
                                    <div class="users-list-body">
                                      ...
                                      <div class="last-chat-time">
                                        ...
                                        <div class="chat-pin">
                                          <i class="fa-solid fa-thumbtack me-2" />
                                ...
                                <li class="user-list-item chat-user-list">
                                  <a href="javascript:void(0);">
                                    <div>
                                      <div class="avatar ">
                                        <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user5.jpg" class="rounded-circle" alt="image" />
                                      </div>
                                    </div>
                                    <div class="users-list-body">
                                      <div>
                                ...
                                <li class="user-list-item chat-user-list">
                                  <a href="javascript:void(0);">
                                    <div class="avatar avatar-online">
                                      <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user3.jpg" class="rounded-circle" alt="image" />
                                    </div>
                                    <div class="users-list-body">
                                      <div>
                                      ...
                                      <div class="last-chat-time">
                                        ...
                                        <div class="chat-pin">
                                          <i class="fa-solid fa-thumbtack me-2" />
                                          <i class="fa-solid fa-check-double check" />
                                        </div>
                                      </div>
                                    </div>
                                  </a>
                              ...
                              <ul class="user-list">
                                <li class="user-list-item chat-user-list">
                                  <a href="javascript:void(0);">
                                    <div class="avatar avatar-online">
                                      <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user11.jpg" class="rounded-circle" alt="image" />
                                    </div>
                                    <div class="users-list-body">
                                      <div>
                                        <h5>Horace Keene</h5>
                                  ...
                                  <div class="chat-hover ms-1">
                                    <div class="chat-action-col">
                                      ...
                                      <div class="dropdown-menu chat-drop-menu dropdown-menu-end">
                                        ...
                                        <span class="dropdown-item" data-bs-toggle="modal" data-bs-target="#block-user">
                                          <span>
                                            <i class="bx bx-block" />
                                          </span>Block
                                        </span>
                                ...
                                <li class="user-list-item chat-user-list">
                                  <a href="javascript:void(0);">
                                    <div>
                                      <div class="avatar avatar-online">
                                        <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user4.jpg" class="rounded-circle" alt="image" />
                                      </div>
                                    </div>
                                    <div class="users-list-body">
                                      <div>
                                        <h5>Hollis Tran</h5>
                                        <p>
                                          <i class="bx bx-video me-1" />Video
                                        </p>
                                      </div>
                                      <div class="last-chat-time">
                                        <small class="text-muted">
                                ...
                                <li class="user-list-item chat-user-list">
                                  <a href="javascript:void(0);">
                                    <div class="avatar">
                                      <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user.jpg" class="rounded-circle" alt="image" />
                                    </div>
                                    <div class="users-list-body">
                                      <div>
                                        <h5>James Albert</h5>
                                        <p>
                                          <i class="bx bx-file me-1" />Project Tools.doc
                                        </p>
                                      </div>
                                      <div class="last-chat-time">
                                        <small class="text-muted">
                                ...
                                <li class="user-list-item chat-user-list">
                                  <a href="javascript:void(0);">
                                    <div>
                                      <div class="avatar avatar-online">
                                        <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user6.jpg" class="rounded-circle" alt="image" />
                                      </div>
                                    </div>
                                    <div class="users-list-body">
                                      <div>
                                        <h5>Debra Jones</h5>
                                        <p>
                                          <i class="bx bx-microphone me-1" />Audio
                                        </p>
                                      </div>
                                      <div class="last-chat-time">
                                        <small class="text-muted">
                                ...
                                <li class="user-list-item chat-user-list">
                                  <a href="javascript:void(0);">
                                    <div>
                                      <div class="avatar ">
                                        <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user1.jpg" class="rounded-circle" alt="image" />
                                      </div>
                                    </div>
                                    <div class="users-list-body">
                                      <div>
                                ...
                                <li class="user-list-item chat-user-list">
                                  <a href="javascript:void(0);">
                                    <div>
                                      <div class="avatar avatar-online">
                                        <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user13.jpg" class="rounded-circle" alt="image" />
                                      </div>
                                    </div>
                                    <div class="users-list-body">
                                      <div>
                                        ...
                                        <p class="missed-call-col">
                                          <i class="bx bx-phone-incoming me-1" />Missed Call
                                        </p>
                                      </div>
                                      <div class="last-chat-time">
                                        <small class="text-muted">
                              ...
                              <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-end">
                                    <a href="https://dreamslms.dreamstechnologies.com/html/index.html" class="dropdown-item ">
                                      <span>
                                        <i class="bx bx-x" />
                                      </span>Close Chat{" "}
                                    </a>
                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#mute-notification">
                                      <span>
                                        <i class="bx bx-volume-mute" />
                                      </span>Mute Notification
                                    </a>
                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#disappearing-messages">
                                      <span>
                                        <i class="bx bx-time-five" />
                                      </span>Disappearing Message
                                    </a>
                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#clear-chat">
                                      <span>
                                        <i class="bx bx-brush-alt" />
                                      </span>Clear Message
                                    </a>
                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#change-chat">
                                      <span>
                                        <i class="bx bx-trash" />
                                      </span>Delete Chat
                                    </a>
                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#report-user">
                                      <span>
                                        <i class="bx bx-dislike" />
                                      </span>Report
                                    </a>
                                    <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#block-user">
                                      <span>
                                        <i class="bx bx-block" />
                                      </span>Block
                                    </a>
                            ...
                            <div class="messages">
                              <div class="chats">
                                <div class="chat-avatar">
                                  <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user12.jpg" class="rounded-circle dreams_chat" alt="image" />
                                </div>
                                    ...
                                    <div class="chat-action-btns ms-2">
                                      <div class="chat-action-col">
                                        ...
                                        <div class="dropdown-menu chat-drop-menu dropdown-menu-end">
                                          ...
                                          <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#forward-message">
                                            <span>
                                              <i class="bx bx-reply" />
                                            </span>Forward
                                          </a>
                                          ...
                                          <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#delete-message">
                                            <span>
                                              <i class="bx bx-trash" />
                                            </span>Delete
                                          </a>
                              ...
                              <div class="chats chats-right">
                                      ...
                                      <div class="chat-action-col">
                                        ...
                                        <div class="dropdown-menu chat-drop-menu dropdown-menu-end">
                                          ...
                                          <a href="javascript:void(0);" class="dropdown-item click-star-one">
                                            ...
                                            <span class="star-msg-one">
                                              Star Message
                                            </span>
                                          </a>
                                          <a href="javascript:void(0);" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit-message">
                                            <span>
                                    ...
                                    <div class="chat-voice-group">
                                      <ul>
                                        <li>
                                          <a href="javascript:void(0);">
                                            <span>
                                              <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/icon/play-01.svg" alt="image" />
                                            </span>
                                          </a>
                                        </li>
                                        <li>
                                          <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/icon/voice.svg" class="img-fluid" alt="image" />
                                        </li>
                                        <li>0:05</li>
                                      </ul>
                                    </div>
                                ...
                                <div class="chat-avatar">
                                  <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user2.jpg" class="rounded-circle dreams_chat" alt="image" />
                                </div>
                              </div>
                              <div class="chats">
                                <div class="chat-avatar">
                                ...
                                <div class="chat-content">
                                  ...
                                  <div class="message-content award-link chat-award-link">
                                    ...
                                    <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/chat-img-01.jpg" class="img-fluid" alt="img" />{" "}
                                  </div>
                                </div>
                              </div>
                              <div class="chats chats-right">
                                ...
                                <div class="chat-content">
                                  ...
                                  <div class="like-chat-grp">
                                    <ul>
                                      <li class="like-chat">
                                        <a href="javascript:void(0);">
                                          2<img src="https://dreamslms.dreamstechnologies.com/html/assets/img/icon/like.svg" alt="Icon" />
                                        </a>
                                      </li>
                                      <li class="comment-chat">
                                        <a href="javascript:void(0);">
                                          2<img src="https://dreamslms.dreamstechnologies.com/html/assets/img/icon/heart.svg" alt="Icon" />
                                        </a>
                                      </li>
                                    </ul>
                                  </div>
                          ...
                          <form>
                            ...
                            <div class="replay-forms">
                              <div class="chats forward-chat-msg reply-div d-none">
                                ...
                                <div class="chat-avatar">
                                  <img src="https://dreamslms.dreamstechnologies.com/html/assets/img/user/user3.jpg" class="rounded-circle dreams_chat" alt="image" />
                                </div>
                                <div class="chat-content">
                                  <div class="chat-profile-name">
                                    <h6>
                ...
                <div class="footer-widget footer-contact">
                  ...
                  <div class="footer-contact-info">
                    ...
                    <p>
                      ...
                      <a href="https://dreamslms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cbafb9aeaaa6b8a7a6b88baeb3aaa6bba7aee5a8a4a6">
                        [email&#160;protected]
                      </a>
                    </p>
                    <p class="mb-0">
